...
from mbed_tools.project.mbed_tools import init, clone, checkout, libs


@mock.patch("mbed_tools.project.mbed_tools.cli.initialise_project", autospec=True)
...
@mock.patch("mbed_tools.project.mbed_tools.cli.clone_project", autospec=True)
...
@mock.patch("mbed_tools.project.mbed_tools.cli.get_known_libs", autospec=True)
...
@mock.patch("mbed_tools.project.mbed_tools.cli.checkout_project_revision", autospec=True)
